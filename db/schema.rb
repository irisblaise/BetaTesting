...
ActiveRecord::Schema.define(version: 2020_03_12_102130) do
  ...
  create_table "feedbacks", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "version_id"
    t.integer "website_ux", default: 0
    t.integer "website_ui", default: 0
    t.integer "website_design", default: 0
    t.integer "website_fluidity", default: 0
    t.integer "website_latency", default: 0
